    ...
    <div className="flex h-full items-center justify-center">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-y-4">
          ...
          <h2 className="text-2xl text-zinc-900">فرم ورود</h2>
        </div>
        {/* Form fileds */}
        ...
        <button
          disabled={isPending}
          className={`mt-4 flex w-full items-center justify-center gap-3 rounded-2xl bg-[#55A3F0] py-3.5 text-xl text-white ${isPending && "cursor-not-allowed"}`}
        >
